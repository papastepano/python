...
with open(student_info) as student_info:
    ...
    for s in student_info:
        if index:
            ...
            combined_data[parts[0]]["exam_data"] = [] 0
        index += 1
...
for student in combined_data:
    ...
    print(f"{full_name:30}{str(combined_data[student]['exercise_total']):10}{str(excercise_points):10}{str(combined_data[student]['exam_total']):10}{str(combined_data[student]['exam_total'] + excercise_points):10}{str(grade):10}")